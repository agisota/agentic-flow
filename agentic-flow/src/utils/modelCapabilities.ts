 ...
 */
export function canHandleToolCount(modelId: string, toolCount: number): boolean {
 ...
 */
export function getCapabilityReport(modelId: string): string {
